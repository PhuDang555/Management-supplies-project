<x-splade-modal>
    ...
    <x-splade-form action="{{ route('chitiethoadonnhaps.update',$chitiethoadonnhap) }}" :default="$chitiethoadonnhap" method="PUT">
    <x-splade-input name="soluong" label="Count" class="mb-5" />
