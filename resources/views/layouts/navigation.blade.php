        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex md:-my-px md:ml-10 md:flex ">
                        ...
                        <x-nav-link :href="route('khos.index')" :active="request()->routeIs('khos.index')">
                            {{ __('Warehouse') }}
                        </x-nav-link>
                        <!-- <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown placement="bottom-end">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('hoadonnhaps.index')">
                                        {{ __('Import Receipt ') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('hoadonxuats.index')">
                                        {{ __('Export Receipt') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
                        ...
                        <x-dropdown placement="bottom-end">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('chitiethoadonnhaps.index')">
                                        {{ __('Import Detail Receipt ') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('chitiethoadonxuats.index')">
                                        {{ __('Export Detail Receipt') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
